...
#原物料對照表
@app.route("/ingredientTable")
def get_table():
    return render_template("ingredient/IngredientTable.html")

#供應商管理
@app.route("/supplierTable")
def get_supplier_table():
    return render_template("ingredient/Ingredientsupplier.html")
